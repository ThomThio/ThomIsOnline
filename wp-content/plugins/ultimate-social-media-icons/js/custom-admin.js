    ...
    if(sfsi_analyst_popup =="no"){
        if(sfsi_show_option1=="no" && sfsi_show_option2=='no' && sfsi_show_option3 =='no' && sfsi_show_option4 == 'no'){
            ...
            if(SFSI("#ui-id-5").length==0 || SFSI("#ui-id-5").attr('aria-selected')=="false"){
                console.log("'didnt'scroll in t0");
                setTimeout(function(){
                    sfsi_open_admin_section(5);
                    if(SFSI("#ui-id-5").length==0 ||  SFSI("#ui-id-5").attr('aria-selected')=="false"){
                        console.log("'didnt'scroll in t1");

                        setTimeout(function(){
                            sfsi_open_admin_section(5);

                            if(SFSI("#ui-id-5").length==0 ||  SFSI("#ui-id-5").attr('aria-selected')=="false"){
                                console.log("'didnt'scroll in t2");
                                
                                setTimeout(function(){
                                    sfsi_open_admin_section(5);
                                    if(SFSI("#ui-id-5").length==0 ||  SFSI("#ui-id-5").attr('aria-selected')=="false"){
                                        console.log("'didnt'scroll in t3");
                                        
                                        setTimeout(function(){
                                            sfsi_open_admin_section(5);

                                            if(SFSI("#ui-id-5").length>0){
                                                console.log("scroll in t4");

                                                SFSI("#ui-id-3")[0].scrollIntoView(true);
                                            }
                                        },2000);
                                    }else{
                                        console.log("scroll in t3");
        ...
        SFSI("#analyst-install-skip, #analyst-install-action").click(function(){
            ...
            if(SFSI("#ui-id-5").length==0 || SFSI("#ui-id-5").attr('aria-selected')=="false"){
                ...
                if(SFSI("#ui-id-5").length>0){
                    SFSI("#ui-id-5")[0].scrollIntoView(true);
                }
            }
        })
    }
